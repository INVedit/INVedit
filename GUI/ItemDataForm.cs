...
namespace INVedit
{
	public partial class ItemDataForm : Form
	{
        ...
        public void Update(ItemSlot slot)
        {
            ...
            boxColor.Enabled = (item != null && (item.ID == "minecraft:leather_helmet" || item.ID == "minecraft:leather_chestplate" || item.ID == "minecraft:leather_leggings" || item.ID == "minecraft:leather_boots")); //Dyed Leather Armor

            panelColor.Enabled = boxColor.Enabled;
            boxPlayer.Enabled = (item != null && item.ID == "minecraft:skull" );
            btnPreview.Enabled = (item != null && item.ID == "minecraft:skull");
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            picCharHead.Image = null;

            btnPreview.Enabled = false;

            byte[] imageData = downloadData("http://skins.minecraft.net/MinecraftSkins/" + boxPlayer.Text + ".png"); //DownloadData function from here

            if (imageData == null)
            {
                picCharHead.Image = INVedit.Properties.Resources.steve;
        ...
        private void picCharHead_Click(object sender, EventArgs e)
        {
